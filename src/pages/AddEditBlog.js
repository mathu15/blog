...
const options = ["Events", "Interviews", "Updates"];
const AddEditBlog = () => {
  ...
  const getDate = () => {
    ...
    let mm = String(today.getMonth() + 1).padStart(2, "0"); //Januay is 0!
  ...
  const onUploadImage = (file) => {
    ...
    formData.append("upload_preset", "tqkfin6v");
    axios
      .post("http://api.cloudinary.com/v1_1/dezzyzc9c/image/upload", formData)
      .then((resp) => {
    ...
    >
      ...
      >
        <MDBInput
          ...
          required
          label="Title"
          validation="Please provide a titile"
          invalid
        />
        <br />
        <MDBInput
        ...
        <select
          ...
          value={category}
        >
          <option>please select caegory</option>
